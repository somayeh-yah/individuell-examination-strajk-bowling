...
function Shoes({ updateSize, addShoe, removeShoe, shoes }) {
    ...
    const shoeComps = shoes.map((input, index) => {
        ...
        <article className='shoes__form' key={ input.id }>
            ...
            <button data-testid = "remove-player-button" className='shoes__button shoes__button--small' 
    ...
    return (
        <section className="shoes">
            ...
            { shoeComps }
            <button data-testid= "add-button" className="shoes__button" onClick={ () => { addShoe(nanoid()) } }>+</button>
        </section>
    )
}
